    ...
    return angular.module('app.routes', ['ui.router']).config(['$stateProvider', '$urlRouterProvider', '$locationProvider', function($stateProvider, $urlRouterProvider, $locationProvider) {
        ...
        $stateProvider
            ...
            .state('reportBuilder', {
                //parent: 'secure',
                url: '/reportBuilder',
                templateUrl: 'views/reportBuilder.html',
                controller: 'reportBuilderCtrl'
            })
           /* .state('reportBuilder2', {
                //parent: 'secure',
                url: '/reportBuilder2',
                templateUrl: 'views/reportBuilder2.html',
                controller: 'reportBuilder2Ctrl'
            })
            .state('blankpage', {
                url: '/blankpage',
        ...
        $urlRouterProvider.otherwise(function ($injector) {
            ...
            document.querySelector('px-app-nav').markSelected('/reportBuilder');
